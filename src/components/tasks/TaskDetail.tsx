...
export function TaskDetail({ onClose }: { onClose?: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6 md:px-6 space-y-5">
        ...
        <input
          ...
          className="w-full bg-transparent text-lg font-semibold text-zinc-900 outline-none placeholder-zinc-400 dark:text-zinc-100"
        />
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-indigo-200/60 bg-indigo-50/80 px-4 py-3 text-sm font-medium text-indigo-700 transition-all hover:bg-indigo-100/80 hover:shadow-sm dark:border-indigo-800/40 dark:bg-indigo-950/30 dark:text-indigo-300 dark:hover:bg-indigo-950/50"
        >
